...
public class SpotlightSequence {
    ...
    public Queue<SpotlightView.Builder> queue;
...
//            Log.d(TAG,"PLAYING NEXT SPOTLIGHT");
    ...
    private void setConfig(@Nullable SpotlightConfig config) {
        if(config == null){
            ...
            config.setLineAndArcColor(Color.parseColor("#FCAB4C"));
            config.setDismissOnTouch(true);
            config.setMaskColor(Color.parseColor("#C9515151"));
            config.setHeadingTvColor(Color.parseColor("#FFFFFFFF"));
            config.setHeadingTvSize(32);
            config.setSubHeadingTvSize(16);
            config.setSubHeadingTvColor(Color.parseColor("#FFFFFFFF"));
